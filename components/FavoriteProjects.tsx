...
export default function FavoriteProjects() {
  return (
    <div id="favorite-projects" className="-mt-40 bg-[#F1F1F1] dark:bg-black">
          ...
          >
            <div className="relative overflow-hidden">
              <img
                ...
                alt="Deck- Access Management for Cloud Applications"
                className="transform hover:scale-125 transition duration-2000 ease-out w-full bg-inherit"
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2">Deck</h1>
